...
export declare const drawBackgroundImage: (item: Image, canvas: HTMLCanvasElement, context: CanvasRenderingContext2D, viewMatrix: number[], id: string, rerender: () => void, onBackgroundPositionCalculated: (pos: Position) => void) => void;
