...
var _PrintIcon = _interopRequireDefault(require("./svgs/PrintIcon"));
...
var useTools = function useTools() {
  ...
  var tools = (0, _react.useMemo)(function () {
    return [{
      ...
      icon: _PrintIcon.default,
      type: _Tool.default.Print
    }]);
    ...
    var menu = /*#__PURE__*/_react.default.createElement(_reactSpring.animated.div, {
      ...
      onClick: function onClick() {
        if (tool.type === _Tool.default.Image && refFileInput.current) {
          ...
          clear();
        } else if (tool.type === _Tool.default.Zoom) {} else if (tool.type === _Tool.default.Print) {
          print();
