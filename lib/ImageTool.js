...
var drawBackgroundImage = exports.drawBackgroundImage = function drawBackgroundImage(item, canvas, context, viewMatrix, id, rerender, onBackgroundPositionCalculated, backgroundPosition) {
  var position = backgroundPosition || _cacheBackgroundPosition[item.imageData];
  if (position) {
...
var onBackgroundImageComplete = exports.onBackgroundImageComplete = function onBackgroundImageComplete(data, canvas, viewMatrix, handleCompleteOperation) {
